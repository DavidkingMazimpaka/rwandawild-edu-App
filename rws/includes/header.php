...
<div class="top-header">
	<div class="container">
		...
		<ul class="tp-hd-rgt wow fadeInRight animated" data-wow-delay=".5s"> 
			<li class="tol">Toll Number : +250785609006</li>				
...
<div class="header">
	<div class="container">
		...
		<a href="index.php"><img src="images/logo.png" alt="" style="width: 100px; float: left; margin-right: 10px; position: relative;"></a>
			<a href="index.php">Rwanda <span>Wildlife Education Initiative</span></a>	
		</div>
