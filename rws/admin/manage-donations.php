...
$sql = "UPDATE tbldonate SET Status=:status WHERE  id=:id";
$query = $dbh->prepare($sql);
$query -> bindParam(':status',$status, PDO::PARAM_STR);
$query-> bindParam(':id',$id, PDO::PARAM_STR);
$query -> execute();

$msg="donate  successfully read";
}
...
<html>
<head>
<title>RWS | Admin manage Donations</title>
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Manage Donations</li>
            </ol>
...
{				?>		
						  <tr>
							...
							<td width="400"><?php echo htmlentities($result->amount);?></td>
							
								<td width="50"><?php echo htmlentities($result->DonationDate);?></td>
