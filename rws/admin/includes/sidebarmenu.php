						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
									 ...
									 <li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span> All Programs</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
									...
									<li><a href="manage-programs.php"><i class="fa fa-list" aria-hidden="true"></i>  <span>Manage Enrolled courses</span><div class="clearfix"></div></a></li>
									...
									<li><a href="manage-donations.php"><i class="fa fa-file-text-o" aria-hidden="true"></i>  <span>Manage Donations</span><div class="clearfix"></div></a></li>
									...
									<li><a href="manage-membership.php"><i class="fa fa-file-text-o" aria-hidden="true"></i>  <span>Manage Membership</span><div class="clearfix"></div></a></li>
